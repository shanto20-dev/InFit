...
export default class Closet extends Component {
    ...
    componentDidMount() {
        this.props.currentUser().then((result) => {
            ...
            this.props.getUserLikes(thisUser.id);
        });
    }
        ...
        if (this.state.selectedSidebar === "overview") {
            ...
            currentContent = (
                <Clothing
                    ...
                    deleteClothing={this.props.deleteClothing}
                    currentUser={this.state.currentUser}
                    clothing={this.props.clothing}
                />
            );
            ...
            currentContent = (
                <Outfits
                    updateProps={this.updateProps}
                    getUserOutfits={this.props.getUserOutfits}
            ...
            addButton = (
                <div className="upload-clothes-wrapper">
                    <Link to="/outfit/new">
                        <img src={uploadOutfitsIcon} alt="" />
                    </Link>
                    <span onClick={this.newOutfit}>Add Outfit</span>
                    <div className="hider"></div>
                </div>
            );
        } else if (this.state.selectedSidebar === "likes") {
            likesClass = "selected";
            currentContent = (
                <Likes
                    currentUser={this.state.currentUser}
                    ...
                    getUserLikes={this.props.getUserLikes}
                />
            );
        }
            ...
            <div className="closet-wrapper">
                <div className={this.state.sidebarClass}>
                    ...
                    <div className="sidebar-content">
                        ...
                        <div className="divider"></div>
                        <h3
                            className={clothingClass}
                            onClick={this.updateSelected("clothing")}
                        >
                            Clothing
                        </h3>
                        <h3
                        ...
                        <h3
                            ...
                            onClick={this.updateSelected("likes")}
                        >
                            Likes
                        </h3>
                    </div>
